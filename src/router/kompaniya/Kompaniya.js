  ...
  return (
    <div className='kompaniya'>
      ...
      <div className="container">
        ...
        <h4 className='kompaniya_h4'>Kompaniya haqida</h4>
        <h1 className='kompaniya_h1'>Kompaniya haqida umumiy ma'lumot</h1>
        ...
        Kompaniyaning asosiy xususiyati uning Markaziy Osiyoda silindr bloki uchun alyumin kallagi qismlari ishlab chiqaradigan birinchi va yagona zavod ekanligidir. Quyish va yig'ish bo’limlari bir joyda joylashgani va bu tarkibiy qismlarni tashish narxini pasaytirishi zavodning haqiqatan ham noyob ishlab chiqarish ekanligini tasdiqlaydi.</p>
        <p className='kompaniya_desc'> 

Bizning missiyamiz - xavfsizlikka rioya qilgan holda bir jamoa bo’lib, ishlab chiqarish tizimini doimiy ravishda takomillashtirish orqali jahon darajasidagi dvigatellarni yetkazib berish bilan mijozlar talabini kutilgandan ham yuqori darajada qondirish. “UzAuto Motors Powertrain”  sog’likni saqlash va xavfsizlik tizimini birinchi darajali vazifa sifatida ko’rib, mehnat muhofazasi va xavfsizlik tizimiga rioya etishga va uni takomillashtirishga intiladi. Bizning xavfsizlik bo’yicha shiorimiz: "Har bir xodim o‘z uyiga sog‘-salomat qaytishi lozim. Har ishdan. Har sohadan. Har kuni".</p>
        <p className='kompaniya_desc'>Barcha “UzAuto Motors Powertrain”  xodimlari GM kompaniyasining global ishlab chiqarish jarayonlarini o’rgangan va puxta tayyorgarlikdan o’tgan. Ko'plab mutaxassislar chet elda malaka oshirib, GM ning boshqa korxonalarida tajriba orttirishgan. Bizning kompaniya katta yo'lni bosib o'tdi va integratsiyalashgan sifatning yuqori darajasiga ko'tarildi va shu orqali 2014-yilda ISO 9001 sifat sertifikati, 2015-yilda General Motors "BIQ 3" va 2018-yilda "BIQ 4" sifat sertifikatiga erishdi.</p>
        <p className='kompaniya_desc'>“UzAuto Motors Powertrain”  atrof-muhitni muhofaza qilishga ham katta ahamiyat beradi. 2014-yilda kompaniya ekologik menejment tizimini joriy qildi va ISO 14001 xalqaro sertifikatiga ega bo'ldi. 2018-yilda esa energiya sarfini kamaytirish va energiya tejash madaniyatini oshirishga erishgan holda ISO 50001 energiya menejmenti tizimini joriy etdi. Kompaniyada oqava suvlarni tozalash uchun noyob inshoot o'rnatilgan bo’lib, bu oqava suvlar tarkibidagi neft mahsulotlari miqdorini yuqori darajada tozalash imkonini beradi.</p>
        <p className='kompaniya_desc'>“UzAuto Motors Powertrain”  O’zbekiston avtomobillari uchun jahon sifat standartlariga mos keladigan dvigatellarni ishlab chiqaruvchi eng yaxshi ishchilarni yollovchi va iqtisodiyot rivojiga munosib hissa qo'shib kelayotgan mamlakatimizning yetakchi korxonalaridan biri ekanligidan faxrlanadi.</p>
        ...
        Kompaniyaning rivojlanish tarixi va xronologiyasi</h1>
